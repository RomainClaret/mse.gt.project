...
func _ready():
	...
	for mushroom_blue in mushrooms_blue:
		mushroom_blue.connect("pick_up", $Player/GUI, "_on_Mushroom_Blue_pick_up")
		
	for mushroom_red in mushrooms_red:
		mushroom_red.connect("pick_up", $Player/GUI, "_on_Mushroom_Red_pick_up")

	for mushroom_yellow in mushrooms_yellow:
		mushroom_yellow.connect("pick_up", $Player/GUI, "_on_Mushroom_Yellow_pick_up")
